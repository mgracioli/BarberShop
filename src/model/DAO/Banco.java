//aqui ele criou varios arrays list para fingir que é um banco de dados
...
public class Banco {
    ...
    public static ArrayList<Usuario> usuario; //usuario (em verde) é uma variavel do tipo ArrayList que armazena informações do tipo Usuario (poderia armazenar, por exemplo, String, int, float...)
    ...
    public static void inicia(){
        ...
        //criando elementos
        Usuario usuario1 = new Usuario(1, "admin", 'M', "09/05/1996", "30212121", "barbeiro@barbershop.com", "521454123", "admin", "administrador");
