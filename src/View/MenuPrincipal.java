...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("BarberShop Menu Principal");
        ...
        LabelFundoMenuPrincipal.setPreferredSize(new java.awt.Dimension(920, 710));
        getContentPane().add(LabelFundoMenuPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 920, 680));

        MenuCadastro.setText("  Cadastro  ");
        MenuCadastro.setActionCommand("Cadastro  ");
        MenuCadastro.setFont(new java.awt.Font("DejaVu Sans", 1, 12)); // NOI18N
        ...
        MenuOperacao.setFont(new java.awt.Font("DejaVu Sans", 1, 12)); // NOI18N
        ...
        MenuRelatorio.setFont(new java.awt.Font("DejaVu Sans", 1, 12)); // NOI18N
    ...
    private void MenuItemAgendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenuItemAgendaActionPerformed
        //chama o metodo que leva para a agenda quando clica no Menu Agenda (MenuItemAgenda)
